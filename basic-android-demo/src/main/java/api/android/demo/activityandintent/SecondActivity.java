...
public class SecondActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i(CommonConstants.LOGCAT_TAG_NAME, "Second - onCreate TaskId=" + getTaskId() )  ;
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		Log.i(CommonConstants.LOGCAT_TAG_NAME, "Second - onPauseTaskId=" + getTaskId())  ;
	}
	...
	protected void onRestart() {
		// TODO Auto-generated method stub
		super.onRestart();
		Log.i(CommonConstants.LOGCAT_TAG_NAME, "Second - onRestart TaskId=" + getTaskId())  ;
	}
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		Log.i(CommonConstants.LOGCAT_TAG_NAME, "Second - onResume TaskId=" + getTaskId())  ;
	}
