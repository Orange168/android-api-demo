...
public class FormWidgetActivity extends Activity {
    	...
    	toggButton.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if(isChecked)
				{
					...
					Toast.makeText(FormWidgetActivity.this, "��", 2000).show() ;
				}
				else
				{
    ...
    private void showTextView()
    {
    	...
    	SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("#��Һ�#�����������Ŷ��")  ;    	
    	...
    	ClickableSpan clickableSpan = new ClickableSpan() {
			...
			public void onClick(View widget) {
				// TODO Auto-generated method stub
				Toast.makeText(FormWidgetActivity.this, "������", 3000).show() ;
			}
		};
