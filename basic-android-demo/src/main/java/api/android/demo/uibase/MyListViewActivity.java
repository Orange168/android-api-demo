...
import api.android.demo.uibase.*;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Toast.makeText(MyListViewActivity.this,"ѡ���ˣ�"+arg0.getSelectedItemId(), 2000).show() ;
			}
		...
		listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Toast.makeText(MyListViewActivity.this,"ѡ����::��"+arg2, 2000).show() ;
				// TODO Auto-generated method stub
