 ...
 * 
 */
package api.android.demo.uibase;
...
public class ViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		radioGroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				if(checkedId == R.id.radio0)
					Toast.makeText(ViewActivity.this, "��ѡ��������", Toast.LENGTH_SHORT).show() ;
				else if(checkedId == R.id.radio1)
					Toast.makeText(ViewActivity.this, "��ѡ����Ů��", Toast.LENGTH_SHORT).show() ;
		...
		spinner1.setOnItemSelectedListener(new OnItemSelectedListener(){
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				// TODO Auto-generated method stub
				Toast.makeText(ViewActivity.this, "��ѡ��ĳ����ǣ�"+cities[arg2], Toast.LENGTH_SHORT).show() ;
			}

			@Override
			public void onNothingSelected(AdapterView<?> arg0) {
				// TODO Auto-generated method stub
				Toast.makeText(ViewActivity.this, "��ʲô��û��ѡ��", Toast.LENGTH_SHORT).show() ;
			}
		...
		dp.init(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DAY_OF_MONTH), new DatePicker.OnDateChangedListener(){
			...
			public void onDateChanged(DatePicker view, int year,
				...
				Toast.makeText(ViewActivity.this, "ʱ���ǣ�"+cal.getTime().toLocaleString() , Toast.LENGTH_SHORT).show() ;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if(item.getItemId() == R.id.itemAbout)//Notification
		{
			...
			//Notification���������¼���Ϣ
			notify.setLatestEventInfo(ViewActivity.this, "��ã����ѽɷ�!", "���Ѿ�Ƿ��������ˣ��뾡��ɷ�", pi)  ;
			//��������
